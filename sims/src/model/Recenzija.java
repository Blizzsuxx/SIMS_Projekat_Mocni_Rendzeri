...
public Recenzija(MuzickoDjelo delo, Date d, boolean bf, String string, Urednik u, String trim) {
...
public void setAll(String text, String naslov2, Izvodjac i, MuzickoDjelo md) {
