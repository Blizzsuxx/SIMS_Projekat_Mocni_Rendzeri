...
public abstract class Korisnik {
   ...
   public Korisnik(String ime, String prezime, String eMail, Pol pol, Date datumRodjenja, boolean status) {
   ...
   public Korisnik(String ime, String prezime, String eMail, Pol pol, Date datumRodjenja, boolean status, Nalog nalog) {
	   super();
	   this.ime = ime;
	   this.prezime = prezime;
	   this.eMail = eMail;
