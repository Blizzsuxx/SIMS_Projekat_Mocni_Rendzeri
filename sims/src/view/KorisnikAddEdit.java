		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (indikator == Uloga.ADMIN) {
					k = new Administrator(ime, prezime, eMail, p, datumRodjenja, true, n);
				} else if (indikator == Uloga.KORISNIK) {
					k = new KorisnikAplikacije(ime, prezime, eMail, p, datumRodjenja, true, n, 
							new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
				} else { // UREDNIK
					k = new Urednik(ime, prezime, eMail, p, datumRodjenja, true, n,
							new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
				}
