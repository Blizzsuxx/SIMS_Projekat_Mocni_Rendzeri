...
public class Administrator extends Korisnik {
   ...
   public Administrator(String ime, String prezime, String eMail, Pol pol, Date datumRodjenja, boolean status, Nalog nalog,int sifra,
   ...
   public Administrator(String ime, String prezime, String eMail, Pol pol, Date datumRodjenja, boolean status,int sifra,
		Nalog nalog) {
	   super(ime, prezime, eMail, pol, datumRodjenja, status, nalog, sifra);
